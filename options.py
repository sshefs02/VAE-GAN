...
# LOCAL
parser.add_argument('--train_img_dir', type=str, default='/Users/shesriva/Desktop/RA/VAE-GAN/data/img_align_celeba')
parser.add_argument('--train_attr_path', type=str, default='/Users/shesriva/Desktop/RA/VAE-GAN/data/list_attr_celeba_full.txt')
parser.add_argument('--test_img_dir', type=str, default='/Users/shesriva/Desktop/RA/VAE-GAN/data/img_align_celeba')
parser.add_argument('--test_attr_path', type=str, default='/Users/shesriva/Desktop/RA/VAE-GAN/data/list_attr_celeba_full.txt')

#GPU
# parser.add_argument('--train_img_dir', type=str, default='/tmp/shefali/data/img_align_celeba')
# parser.add_argument('--train_attr_path', type=str, default='/tmp/shefali/VAE-GAN/data/list_attr_celeba_full.txt')
# parser.add_argument('--test_img_dir', type=str, default='/tmp/shefali/data/img_align_celeba')
# parser.add_argument('--test_attr_path', type=str, default='/tmp/shefali/VAE-GAN/data/list_attr_celeba_full.txt')
...
parser.add_argument("--n_epochs",default=2,action="store",type=int,dest="n_epochs")
